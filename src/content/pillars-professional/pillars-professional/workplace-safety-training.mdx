...
1. MHSWR Regulation 13 — verify the regulation text quoted in Section 1.2 against current MHSWR.
2. Section 1.3 specific regulation references — verify all named regulations and the specific training duty articles.
3. Section 3.7 HSWFAR 1981 and L74 framework — verify both currency.
4. Section 3.7 EFAW and FAW course durations (1-day, 3-day) — verify against current HSE-approved providers.
5. Section 3.7 certificate validity (3 years) — verify.
6. Section 3.5 IPAF, CISRS, PASMA — verify all currency.
7. Section 3.8 CSCS / SMSTS / SSSTS / CITB — verify currency.
8. Section 3.8 Driver CPC and ADR — verify currency.
9. Section 4.1-4.4 IOSH / NEBOSH course names — verify current titles (NEBOSH National General Certificate, National Diploma; IOSH Managing Safely; CMIOSH).
10. Section 4.5 NEBOSH National Certificate in Fire Safety, NEBOSH National Certificate in Construction Health and Safety, NEBOSH National Certificate in Environmental Management — verify currency of all course titles.
11. Section 4.5 British Safety Council qualifications — verify current portfolio names.
12. Section 5.1 refresher frequencies — these are practitioner consensus rather than regulatory; verify against current HSE guidance.
13. Section 3.6 asbestos awareness annual refresh expectation — verify against current CAR 2012 and HSE guidance.
14. Section 1.4 Section 40 HSWA reverse burden — verify (referenced in detail in the H&S RA professional pillar).
15. Section 6 online versus practical training — verify the editorial position is defensible to training industry practitioners and to HSE expectations.
16. Section 10 enforcement themes — practitioner should add specific named prosecutions; particularly any post-2016 cases involving training inadequacies contributing to fatal or serious injury.
17. Section 3.2 fire marshal coverage requirements — verify against RRO 2005 Article 21 and current fire safety practice.
18. Section 3.3 MHOR 1992 hierarchy — verify against current text of Regulation 4.
19. Section 3.5 WAHR 2005 hierarchy — verify against current Regulation 6.
20. Section 3.6 CAR 2012 Regulation 10 training duty — verify against current text and the three-level framework described.
-->
