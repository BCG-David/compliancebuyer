...
1. MHSWR 1999 SI number (1999/3242) — verify.
2. Section 1.1 HSWA section references (2, 3, 4, 7, 33, 37, 40) — verify current.
3. Section 1.2 MHSWR regulation list (3-19) — verify all current.
4. Section 2.1 Edwards v National Coal Board [1949] 1 KB 704 citation — verify and confirm quote accuracy.
5. Section 2.2 R v Chargot Limited [2008] UKHL 73 citation — verify and confirm holding accuracy on Section 40 reverse burden.
6. Section 4 SDS reference and CLP regulation (Regulation 31) — verify against current retained EU law / UK CLP regulation.
7. Section 5.3 CLP Regulation (EC) No 1272/2008 — verify retained law status post-Brexit; check if there is a separate UK CLP.
8. Section 5.6 WAHR 2005 strict hierarchy — verify against current text of Regulation 6.
9. Section 5.7 Control of Noise at Work Regulations 2005 action values (80/85/87 dB(A); 135/137/140 dB(C)) — verify.
10. Section 5.8 Control of Vibration at Work Regulations 2005 action values (HAV 2.5/5 m/s²; WBV 0.5/1.15 m/s²) — verify.
11. Section 5.9 Personal Protective Equipment at Work Regulations 2022 amendment — verify the post-2022 framework.
12. Section 7 Regulation 6 surveillance trigger criteria — verify against current Regulation text.
13. Section 7 specific regulations triggering surveillance — verify each (COSHH Schedule 6, CNWR, CVWR, CAR, CLAW).
14. Section 8 IOSH and NEBOSH qualification names — verify current course titles (NEBOSH National General Certificate, National Diploma; IOSH Managing Safely; CMIOSH).
15. Section 8.1 CITB SMSTS — verify current scheme name.
16. Section 12.1 Sentencing Council Guideline — verify "in force since February 2016"; check for any subsequent amendments.
17. Section 12.2 Company Directors Disqualification Act 1986 — verify.
18. Section 12 enforcement themes — practitioner should add specific named cases for credibility; verifier with current case law access should select two or three recent corporate and individual prosecutions.
19. Section 5.5 Manual Handling Operations Regulations 1992 — verify any amendments since enactment.
20. Section 5.4 DSE Regulations 1992 — verify any amendments.
21. Section 6 Regulation 5 explicit five-or-more-employees recording requirement — verify location in MHSWR (Regulation 3(6) for risk assessment record; Regulation 5(2) for arrangements record; verify both numbering).
22. Section 10 health surveillance retention 40 years — verify against current statutory requirements for the specific surveillance types.
-->
