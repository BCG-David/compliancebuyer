...
1. CAR 2012 Schedule 3 referenced in Section 5.1 — verify current schedule reference and content.
2. CAR 2012 Schedule 2A referenced in Section 5.2 and 10 — verify exists as named or check correct schedule for NNLW medical surveillance.
3. BOHS qualification codes (P402, P403, P404, P405) — verify these remain the current designations or whether BOHS has updated nomenclature.
4. HSG264 (2nd Edition, 2012) referenced — confirm 2nd Edition is current; check for any subsequent updates.
5. HSG227 (2nd Edition) referenced — verify edition number.
6. HSG247 (2nd Edition) and HSG248 (2nd Edition) — verify edition numbers.
7. L143 (3rd Edition) referenced — verify edition.
8. Control limit of 0.1 f/cm³ over four-hour reference — confirm current value in EH40.
9. The HSE Asbestos Licensee List — confirm name and public accessibility.
10. Medical surveillance retention requirement of 40 years — verify against current CAR 2012 / general health record retention requirements.
11. Hazardous Waste Regulations 2005 — verify still in force in current form for England and Wales; check Northern Ireland and Scotland equivalents.
12. Section 11 BOHS course title for P405 — verify "Management of Asbestos in Buildings" is correct.
13. "Equal Treatment Directive (2003/18/EC)" — verify directive number and applicability.
14. The 1985 crocidolite ban date — verify against authoritative source.
15. The licensed work threshold of 0.1 f/cm³ control limit — verify this is the actual trigger threshold for licensing rather than a related but separate value.
16. The HSE renewal periods for asbestos licences (1, 2, or 3 years) — verify against current HSE guidance.
17. The 14-day notification period for licensed work — verify against current Regulation 9 / supplementary guidance.
18. The 7-day notification period for unforeseen work — verify against current guidance.
19. AIB asbestos content (16-40%) — confirm range matches authoritative source.
20. Sprayed coating asbestos content (55-85%) — confirm range.
21. Lagging asbestos content (6-85%) — confirm range.
22. Section 12 enforcement themes — consider whether to add specific named case examples (post-2018 prosecutions with public reporting); verifier with current asbestos case law access should identify two or three specific cases to cite.
-->
