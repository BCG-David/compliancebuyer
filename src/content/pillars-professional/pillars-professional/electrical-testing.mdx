...
1. BS 7671:2018+A2:2022 — confirm current edition; check for any Amendment 3 publication.
2. IET Guidance Note 3 edition reference — verify currency (stated as 9th Edition; confirm).
3. Section 3 frequency tables — cross-check against current IET Guidance Note 3.
4. Construction site 3-month interval — verify against current IET GN3.
5. Petrol filling station 1-year interval — verify.
6. Section 5 code classifications — verify wording against BS 7671 Appendix 6 current text.
7. C3 handling section — practitioner verification recommended; ensure the editorial position is defensible against the dominant market interpretation.
8. Section 7 EIC and MEIWC certificates — verify naming and current usage.
9. Section 8 thermography certifications (ITC, BINDT, Level I/II) — verify current designations.
10. Section 9 healthcare HTM 06-01 reference — verify current document number.
11. Section 9 BS 7671 Section 710 reference — verify (medical locations).
12. Section 10 competent person schemes (NICEIC, NAPIT, ELECSA, STROMA, BESCA) — verify these remain the principal recognised schemes.
13. Section 10 City & Guilds 2391 — verify still the primary qualification.
14. Section 12 enforcement themes — consider adding specific named case examples (post-2020) for credibility; verifier with current case law access should select two or three.
15. The statutory residential rental requirement (Electrical Safety Standards Regulations 2020) — verify the framework as stated and that no significant amendment has been made.
16. RCD operation testing — verify current required test in BS 7671 Section 6.
17. Section 4 default test sample of 20% — verify against current IET GN3 guidance on sampling.
18. The 18th Edition Amendment 2 publication date (March 2022, effective September 2022) — verify.
-->
